                ...
                <{if $photos[photo].photo_id}>
                    ...
                    <{if $use_ajax_effects == overlay}>
                        ...
                        <div class="apple_overlay" id="photo<{$photos[photo].photo_id}>"><a class="close"></a>
                            ...
                            <div class="details">
                                <{if $photos[photo].photo_serveur && $photos[photo].photo_name}>
                                    <div align="center"><a title="<{$photos[photo].photo_title}>"
                    ...
                    <{if $enable_info}>
                        ...
                        <{if $enable_photo_hits}>
                            <div class="photoDesc"><h5><{$photos[photo].photo_hits}> <{$lang.hits}></h5></div>
                        <{/if}>
                        <!-- End Hit count -->

                        <!-- Start Comment count -->
                        <{if $enable_show_comments}>
                            <div class="photoExtra"><h5><{$photos[photo].photo_comment}> <{$lang.comments}></h5></div>
                        <{/if}>
                        <!-- End Comment count -->
